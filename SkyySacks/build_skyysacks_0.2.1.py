...
Run:   python build_skyysacks_0.2.1.py            -> SkyySacks/SkyySacks-0.1.1.jar
       python build_skyysacks_0.2.1.py --deploy   -> also copies to Mods/SkyySacks.jar and enables it in the HUD mod world
