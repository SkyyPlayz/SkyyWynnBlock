"""SkyySacks 0.7.5 - build script (javassist via jpype).
Run:   python build_skyysacks_0.7.5.py            -> SkyySacks/SkyySacks-0.7.5.jar
       python build_skyysacks_0.7.5.py --deploy   -> also copies to Mods/SkyySacks.jar and enables it in the HUD mod world
