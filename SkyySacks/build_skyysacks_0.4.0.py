...
Run:   python build_skyysacks_0.4.0.py            -> SkyySacks/SkyySacks-0.1.1.jar
       python build_skyysacks_0.4.0.py --deploy   -> also copies to Mods/SkyySacks.jar and enables it in the HUD mod world
...
public void setup() {{
  ...
  getLogger().at(java.util.logging.Level.INFO).log("[SkyySacks] {VERSION} ready - /sacks (/pd) or right-click a magic bag");
}}""", pl))
pl.addMethod(CtNewMethod.make(f"""
