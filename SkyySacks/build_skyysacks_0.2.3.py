...
Run:   python build_skyysacks_0.2.3.py            -> SkyySacks/SkyySacks-0.1.1.jar
       python build_skyysacks_0.2.3.py --deploy   -> also copies to Mods/SkyySacks.jar and enables it in the HUD mod world
...
public void build({REF} ref, {UCB} b, {UEB} ev, {ST} st) {{
  ...
  b.appendInline("#SkyySacks", "Label #SkyySCap {{ Anchor: (Height: 16); Text: \\"" + safe(this.cat + " sack   " + stored + " / " + capacity + (capacity == 0L ? "   (carry a " + this.cat + " sack to pool items)" : "")) + "\\"; Style: (FontSize: 11, RenderBold: true, TextColor: #ffe9c9, HorizontalAlignment: Center, VerticalAlignment: Center); }}");
  ...
  for (int r = 0; r < 4; r++) {{
    ...
    for (int c = 0; c < 9; c++) {{
      ...
      if (idx < entries.size()) {{
        ...
        this.cells[idx] = id;
        b.appendInline("#SkyySRow" + r, "Button #SkyySCell" + idx + " {{ Anchor: (Width: 42, Height: 42); Style: ButtonStyle( Default: ( Background: #1d3a5f ), Hovered: ( Background: #2f5a8f ), Disabled: ( Background: #1a2c3c ) ); ItemIcon {{ Anchor: (Width: 32, Height: 32, Left: 5, Top: 3); ItemId: \\"" + safe(id) + "\\"; }} Label {{ Anchor: (Width: 40, Height: 10, Right: 2, Bottom: 1); Text: \\"" + cnt + "\\"; Style: (FontSize: 8, RenderBold: true, TextColor: #ffffff, HorizontalAlignment: End); }} }}");
  ...
  b.appendInline("#SkyySacks", "Label #SkyySInfo {{ Anchor: (Height: 16); Text: \\"" + safe(this.info) + "\\"; Style: (FontSize: 10, TextColor: #c9b89a, HorizontalAlignment: Center, VerticalAlignment: Center); }}");
  ...
  b.appendInline("#SkyySAct", "Label {{ Anchor: (Width: 8, Height: 22); Text: \\"\\"; }}");
  b.appendInline("#SkyySAct", "Label {{ Anchor: (Width: 130, Height: 22); Text: \\"left click takes a stack - right click takes one\\"; Style: (FontSize: 9, TextColor: #8fa4b8, VerticalAlignment: Center); }}");
