...
9. LOCKED 2026-09-25 (Skyy): seeded ranks are Member, Admin, and Developer. Admin and Developer are close to the owner and do not get full op. Developer also gets the rank editor. Was: only Member. All ranks, including these three, are fully editable in the in-game Server Setup ranks editor. Permissions can be changed and new ranks added from the menu without editing files. [Member, Admin, Developer; 0.1 still seeds only Member; 0.1 still refuses grants, delete, and ladder moves on the default rank]
