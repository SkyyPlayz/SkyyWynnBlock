...
kunai throwing knife), Berserker=Berserking (axes, battleaxes, maces, clubs), Mage = coming soon (card shown greyed, not selectable;
...
CLASSES = [
    ...
    {"name": "Mage", "skill": "Magic", "color": "#7fb0e0", "enabled": False,
     "desc": "Coming soon. The Mage waits for the magic Hytale is building - staves and wands and spellbooks stay locked until then.",
     "icons": ["Weapon_Staff_Iron", "Weapon_Wand_Wood", "Weapon_Spellbook_Fire"],
     "weapons": [("Weapon_Staff_", "staves"), ("Weapon_Wand_", "wands"), ("Weapon_Spellbook_", "spellbooks"), ("Halloween_Broomstick", "broomsticks")],
     "weapon_text": "Staves / Wands / Spellbooks"},
]
...
for c, m in ((T["DMG"], "setCancelled"), (T["DMG"], "setAmount"), (T["DMG"], "getSource"), (T["DMG"], "isCancelled"),
             ...
             (AC, "addSubCommand"), (AC, "addAliases"), (AC, "requirePermission"), (AC, "withRequiredArg"),
...
C(cmd, r"""
public ClassCmd() {
  super("class", "Open the class page (Archer, Warrior, Assassin, Berserker)");
...
public AdminSetCmd() {
  ...
  this.classArg = withRequiredArg("class", "archer | warrior | assassin | berserker", @ATY@.STRING);
}""")
M(aset, r"""
protected void execute(@CTX@ ctx, @ST@ store, @REF@ ref, @PR@ pr, @WLD@ world) {
  try {
...
m = B.manifest("SkyyClasses", VERSION, "SkyWynn classes (Wynncraft style): Archer, Warrior, Assassin, Berserker (Mage soon). Your class decides your weapons and your combat skill; /class to choose. Zero dependencies (SkyyCoins optional for switching).", PKG + ".SkyyClassesPlugin")
