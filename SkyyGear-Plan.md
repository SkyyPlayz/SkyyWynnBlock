...
9. **Stat list and combat application.** The mix is locked (five skill points, plus crit chance, crit damage, and fortune). Anything past that list is open. How each stat applies in Hytale combat is open. Do not invent formulas or extra stats from this plan.
