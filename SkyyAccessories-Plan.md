...
**Lock (2026-09-25, change notes 17–19, `SkyyGear-Plan.md` locks 63–76):** most accessories are crafted. Some come from mobs or chests. Leveling a collection unlocks the next accessory craft tier. Crafting the next rarity needs the previous rarity as an ingredient. That craft ladder is the lock. The bag-slot prices in section 3 stay a draft. Enrichments: keep Speed, Crit Damage, Crit Chance, Strength, Defense, Health, and Attack Speed. Intelligence Enrichment is **Mana % enrichment**. No Intelligence ID. Sea Creature Chance is later, with fishing. Magic Find Enrichment is scrap. Ferocity Enrichment is pending. Ferocity the combat stat stays (cap 300). Do not scrap that stat. The power system stays. Starters lean Keep, pending confirm: No Power, Fortuitous, Pretty, Protected, Simple, Warrior. Warrior's name is TBD. It clashes with the Warrior class. Pretty is a multi-stat blend (Health, Defense, Speed, Strength, mana, Crit Chance, Crit Damage), not one theme. Gear modifier rulings apply to accessories and Equipment the same way. Wiki numbers are research. They are not our numbers.
