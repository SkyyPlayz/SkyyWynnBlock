...
**Lock (2026-09-25, change note 21, `SkyyGear-Plan.md` locks 91–101):** Combat-gated powers mirror the starter themes. They are more extreme. They use buffs and debuffs. Amounts still scale with total Accessory Power. **Glass Cannon** is Keep. It is the Combat 15 form of Slayer: −Health, −Defense, much more Strength and Crit Damage, solid Crit Chance. The other five were drafts at this note. Confirmed later the same day (change note 22). Do not copy Hypixel names Commando, Disciplined, Inspired, Ominous, or Prepared. No Power and stone powers stay pending.
