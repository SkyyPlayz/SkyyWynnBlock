"""SkyyTrees 0.2.2 - build script (javassist via jpype, tools/skyybuild.py). Owner: Skyy (they/them).
...
ALL = (defs, cfg, dat, sto, stk, calc, fx, msg, abil, gat, tfn, bfn, ffn, dmg, tick, svr, ops, page, kitc, vcmd, qcmd, rcmd, cmd, pl)
for c in ALL:
    c.writeFile(OUT)
