"""SkyyCollections 0.1.4 - build script
...
Run:   python build_skyycollections_0.1.4.py            -> SkyyCollections/SkyyCollections-0.1.4.jar
       python build_skyycollections_0.1.4.py --deploy   -> also copies to Mods/SkyyCollections.jar and enables it in the HUD mod world
...
for c in (store, unl, sysc, sav, ccmp, page, ulc, rlc, cmd, pl):
    c.writeFile(OUT)
