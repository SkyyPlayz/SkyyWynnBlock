...
Run:   python build_skyycollections_0.1.1.py            -> SkyyCollections/SkyyCollections-0.1.1.jar
       python build_skyycollections_0.1.1.py --deploy   -> also copies to Mods/SkyyCollections.jar and enables it in the HUD mod world
