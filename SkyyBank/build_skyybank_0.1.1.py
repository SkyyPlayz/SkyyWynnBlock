"""SkyyBank 0.1.1 - build script (javassist via jpype).
Run:   python build_skyybank_0.1.1.py            -> SkyyBank/SkyyBank-0.1.1.jar
       python build_skyybank_0.1.1.py --deploy   -> also copies to Mods/SkyyBank.jar and enables it in the HUD mod world
