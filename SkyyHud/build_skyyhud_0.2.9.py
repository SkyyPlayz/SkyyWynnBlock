...
public void build({REF} ref, {UCB} b, {UEB} ev, {ST} st) {{
  b.appendInline((String) null, "Group #SkyyEditor {{ Anchor: (Width: 720, Height: 800); Background: #0b1524(0.94); Padding: (Horizontal: 14, Vertical: 10); LayoutMode: Top; }}");
  ...
  b.appendInline("#SkyyEditor", "Label {{ Anchor: (Height: 14); Text: \\"Preview (1/3 scale of a 1080p screen). On/Off - anchor - arrows move 10 px - S scales. /skyyhud export | import | reset\\"; Style: (FontSize: 10, TextColor: #9fb8d0, HorizontalAlignment: Center); }}");
  ...
  for (int i = 0; i < ids.length; i++) {{
    b.appendInline("#SkyyEditor", "Group #SkyyERow" + ids[i] + " {{ Anchor: (Height: 44); LayoutMode: Top; Padding: (Vertical: 1); }}");
