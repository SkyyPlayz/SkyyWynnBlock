"""SkyyHud 0.3.6 - build script (javassist via jpype).
...
public void build({REF} ref, {UCB} b, {UEB} ev, {ST} st) {{
  ...
  b.appendInline((String) null, "Group #SkyySet {{ Anchor: (Width: 940, Height: 440); Background: #0b1524(0.96); Padding: (Horizontal: 16, Vertical: 10); LayoutMode: Top; }}");
  ...
  if (l == null) return;
  b.appendInline("#SkyySet", "Group #SkyySetRow1 {{ Anchor: (Height: 58); LayoutMode: Left; Padding: (Top: 12); }}");
  b.appendInline("#SkyySetRow1", "Label {{ Anchor: (Width: 210, Height: 44); Text: \\"Visible\\"; Style: (FontSize: 20, TextColor: #ffffff, VerticalAlignment: Center); }}");
  b.appendInline("#SkyySetRow1", "TextButton #SkyySetOn {{ Anchor: (Width: 104, Height: 44); Text: \\"ON\\"; " + (l.en ? on : bs) + " }}");
  b.appendInline("#SkyySetRow1", "Label {{ Anchor: (Width: 8, Height: 44); Text: \\"\\"; }}");
  b.appendInline("#SkyySetRow1", "TextButton #SkyySetOff {{ Anchor: (Width: 104, Height: 44); Text: \\"OFF\\"; " + (l.en ? bs : on) + " }}");
  ev.addEventBinding({BT}.Activating, "#SkyySetOn", {EVD}.of("a", "on"));
  ev.addEventBinding({BT}.Activating, "#SkyySetOff", {EVD}.of("a", "off"));
  b.appendInline("#SkyySet", "Group #SkyySetRow2 {{ Anchor: (Height: 58); LayoutMode: Left; Padding: (Top: 12); }}");
  b.appendInline("#SkyySetRow2", "Label {{ Anchor: (Width: 210, Height: 44); Text: \\"Background\\"; Style: (FontSize: 20, TextColor: #ffffff, VerticalAlignment: Center); }}");
  b.appendInline("#SkyySetRow2", "TextButton #SkyySetBgOn {{ Anchor: (Width: 104, Height: 44); Text: \\"ON\\"; " + (l.bg ? on : bs) + " }}");
  b.appendInline("#SkyySetRow2", "Label {{ Anchor: (Width: 8, Height: 44); Text: \\"\\"; }}");
  b.appendInline("#SkyySetRow2", "TextButton #SkyySetBgOff {{ Anchor: (Width: 104, Height: 44); Text: \\"OFF\\"; " + (l.bg ? bs : on) + " }}");
  ...
  b.appendInline("#SkyySetRow3", "Label {{ Anchor: (Width: 210, Height: 44); Text: \\"Size " + l.scale + "%\\"; Style: (FontSize: 20, TextColor: #ffffff, VerticalAlignment: Center); }}");
  ...
  b.appendInline("#SkyySetRow4", "Label {{ Anchor: (Width: 210, Height: 44); Text: \\"Snap to\\"; Style: (FontSize: 20, TextColor: #ffffff, VerticalAlignment: Center); }}");
