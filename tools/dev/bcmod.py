...
for spec in sys.argv[2:]:
    ...
    for mm in cc.getDeclaredMethods():
        if str(mm.getName()) == m:
            ...
            s = str(bos.toString())
            lines = [l for l in s.splitlines() if "invoke" in l or "getstatic" in l or "putstatic" in l or "ldc" in l or "new " in l or "checkcast" in l or "getfield" in l or "putfield" in l]
