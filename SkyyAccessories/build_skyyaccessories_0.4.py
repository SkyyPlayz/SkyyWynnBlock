"""SkyyAccessories 0.4 - build script (derived from 0.3 by tools/acc_0_4_patch.py - edit the patch, not this file)
...
public void setup() {{
  ...
  getLogger().at(java.util.logging.Level.INFO).log("[SkyyAccessories] {VERSION} ready - /accessories, right-click the Accessory Bag; %d bench accessories + Omni, %d talismans in 5 rarities (percent layer on)" );
