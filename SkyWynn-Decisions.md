...
8. **SkyyGear, next pass (same day, after note 7).** Locks rows 5.3, 5.10, 5.11, 5.14, 5.16, 5.17, and 10.10. Detail in `SkyyGear-Plan.md`. Cross-check `SkyyAccessories-Plan.md`. Does not change any jar.
   ...
   - **Accessory Power.** Each accessory gives its own buff and also adds accessory power. Total power feeds one selectable buff. More power means a stronger buff. Locked examples: Warrior (strength as a damage modifier, plus a small amount of crit chance, crit damage, health, and defence) and Elementalist (all elemental damage types, and all elemental resistance). **Open at this note:** the rest of the buff list, and the numbers. Starters lean Keep, pending confirm (change note 19). Warrior's name is TBD. The crystal table in `SkyyAccessories-Plan.md` stays a draft. The accessory craft ladder is change note 17.
...
13. **Accessory enrichments (change note 18).** Rows 6.48. Plan locks 66–70. Does not change any jar. Gear modifier rulings apply to accessories and Equipment the same way.
   ...
   - **Mana % enrichment.** Was Intelligence Enrichment. Mana %. No Intelligence ID.
   - **Sea Creature Chance Enrichment.** Add later. With fishing.
   - **Magic Find Enrichment.** Scrap.
   - **Ferocity Enrichment.** Pending captain. They said "not in the pack". Ferocity the combat stat stays. Cap 300. Do not scrap that stat.
14. **Accessory power starters (change note 19).** Rows 6.49. Plan locks 71–76. Leaning Keep. Pending confirm. Does not change any jar. Next blank table is the rest of SkyBlock accessory powers.
   - The power system stays.
   - **Starters.** No Power, Fortuitous, Pretty, Protected, Simple, Warrior.
   - **Warrior.** Rename TBD. The name clashes with the Warrior class. This is the change note 8 example, pending that rename. Not a second power.
   - **Pretty.** Multi-stat blend. Health, Defense, Speed, Strength, mana, Crit Chance, Crit Damage. Not one theme.
   - Any SkyBlock Intelligence line on an accessory is mana %. Wiki numbers are research. They are not our numbers.
...
| 6.48 | Accessory enrichments | SkyBlock | | ✔ LOCKED (2026-09-25, change note 18) — keep Speed, Crit Damage, Crit Chance, Strength, Defense, Health, Attack Speed. Intelligence Enrichment is Mana % enrichment. Sea Creature Chance is later. Magic Find Enrichment is scrap. Ferocity Enrichment is pending. Ferocity the stat stays (cap 300) |
| 6.49 | Accessory power starters | SkyBlock | | ✔ LEANING KEEP (2026-09-25, change note 19) — pending confirm. System stays. Starters: No Power, Fortuitous, Pretty, Protected, Simple, Warrior (rename TBD). Pretty is a multi-stat blend. Intelligence lines are mana %. Wiki numbers are research |
