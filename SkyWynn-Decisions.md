...
7. **Gear stats are a mix (same day, after note 6).** Locks rows 1.6 and 6.5. Replaces the "proposed, not locked" stat split in note 6. Weapons and armor carry Wynn's five skill points (Strength, Dexterity, Intelligence, Defence, Agility), with SkyBlock-style stats layered on top. Crit chance, crit damage, and fortune are in that layer. Gathering armor uses this same mix. **Open at this note:** the exact stat list beyond these, and how each stat applies in Hytale combat. Does not change any jar. **Revised later the same day (change note 9):** the five Wynn skill points are not the gear sheet. Strength is SkyBlock-style. Dexterity, Wynn Defence, Wynn Intelligence, and Wynn Agility are not gear skill points. Fortune from this note was not re-opened.
...
9. **Combat, defence, and mana (same day, after the catalog).** Locks rows 1.6, 6.4, and 6.5, and adds 6.10–6.13. Full list in `SkyyGear-Plan.md` locks 15–24. Marked in `SkyyGear-Stat-Catalog.md`. The next blank table at this note was Movement. Locked later (change note 10). Does not change any jar.
   ...
   - **Strength** is SkyBlock-style, on weapons, armor, and Equipment. Class skill trees can raise base Strength. **Dexterity is not a skill point.**
   - Flat **Earth / Thunder / Water / Fire / Air** are weapon-only. Base Damage is cut by Defence. Element damage is applied on its own, then cut or raised by element affinity and elemental defence. Same model as Wynncraft.
   ...
   - **Dodge Chance** replaces Wynn Agility. It is part of Acrobatics: a small % per level, bigger upgrades in that tree, plus dodge accessories.
   - **Raw Health Regen** and **Health Regen %** stay, Wynn-style. **Life Steal** heals from all damage dealt. Preferred shape: every 3 seconds, heal for that % of the damage dealt in those 3 seconds. Numbers open. **Vitality**, **Mending**, and **Healing Efficiency** are scrap. Crowd healing is a later **Priest** class. Roles are open.
   - **Thorns** is armor only. **Slow Enemy** and **Weaken Enemy** are weapons only. **Reflection** was not called (Open).
   - **Mana** uses Hytale's mana. **+Max Mana** on gear is Equipment only. **Overall Level** (average of all skill levels) raises base Health and Mana. Class trees can add flat Health and Mana. Gathering trees can add a small +%. Amounts per level are open.
   - **Mana Regen** is Equipment, accessories, and magic-class skill trees. **Mana Steal** is weapons and accessories. **Rift Mana is scrap.**
   - Per-spell cost IDs are scrap. One flat **−% Spell Cost**, accessory only. Raw cost drops when a skill is upgraded. **Skill-upgrade points** come every 5 levels. How big the upgrade is stays open.
   - **Class skill trees** are Borderlands-style, not a straight line. Research Borderlands 4. Do not design the trees in this note. See the research bullets in `SkyyGear-Plan.md`.
...
15. **Ferocity caps and custom starters (change note 20).** Rows 6.50. Plan locks 77–90. Does not change any jar. Next blank table is the rest of SkyBlock accessory powers.
   ...
   - **Magical.** Normal Health. Less Defense than the others. Flat mana and mana regen.
   - **Powers.** Flat mana. Not Intelligence. Not mana %.
   - **Dedicated mana accessories.** +% mana.
   - **Pending at this note.** No Power. Combat 15+ Hypixel powers and stone powers are not locked. Hypixel Combat 15 names were scrapped later (change note 21). Stone powers stay pending.
...
16. **Combat 15 power ladder (change note 21).** Rows 6.51. Plan locks 91–101. Does not change any jar. Next blank table is stone powers.
   ...
   - **Drafts. Pending confirm.** Fortress (from Tank). Harmony (from Balance). Fortune (from Lucky). Blitz (from Fast). Arcane (from Magical).
   - **Fortress.** Large Health and Defense. Possible −Speed or −Strength.
   - **Harmony.** Larger even spread. No debuffs, or tiny ones.
   - **Fortune.** High Crit Chance. Possible −Crit Damage or −Strength.
   - **Blitz.** High Speed and Attack Speed. Possible −Defense or −Health.
   - **Arcane.** High flat mana and mana regen. −Defense. Maybe −Strength.
   - **Scrap Hypixel names.** Commando, Disciplined, Inspired, Ominous, Prepared. Do not copy them.
   - **Still pending.** No Power. Stone powers. The exact debuff picks on the drafts.
...
| 1.6 | Skill Points (STR/DEX/INT/DEF/AGI) + gear SP requirements | Wynn | TAKE — but maybe 5 stats is a lot on top of skills+abilities? | ✔ REVISED (2026-09-24, change note 9) — the five Wynn skill points are **not** the gear sheet. **Strength** is SkyBlock-style (weapons, armor, Equipment, and class trees). Dexterity, Wynn Defence, Wynn Intelligence, and Wynn Agility are not gear skill points. Dodge Chance replaces Agility (6.10). **Open:** gear requirements (minimums to equip) |
...
| 5.10 | Accessories/talismans + Accessory Bag + Magical Power + tuning | SkyBlock | TAKE | ✔ **Core**, not later-game. **Tightened 2026-09-24 (change note 8):** each accessory gives its own buff and adds accessory power. Total power feeds one selectable buff; more power, stronger buff. Locked examples: Warrior and Elementalist. **Tightened 2026-09-25 (change notes 17–19):** most accessories are crafted; collections unlock the next craft tier; the next rarity needs the previous rarity. Enrichments: keep Speed, Crit Damage, Crit Chance, Strength, Defense, Health, Attack Speed; Intelligence Enrichment is Mana % enrichment; Sea Creature Chance is later; Magic Find Enrichment is scrap; Ferocity Enrichment is pending (Ferocity the stat stays; enchant cap 300, total cap 600, change note 20). Hypixel starter names are scrap. Custom starters: Tank, Balance, Slayer, Lucky, Fast, Magical. Powers use flat mana. Dedicated mana accessories use +% mana. **Change note 21:** Glass Cannon is Keep. Fortress, Harmony, Fortune, Blitz, and Arcane are drafts. Hypixel Combat 15 names are scrap. **Open:** No Power, stone powers, the draft debuff picks, the numbers, and tuning. The crystal table in `SkyyAccessories-Plan.md` stays a draft. The selected buff is saved in a loadout (5.14) |
...
| 6.10 | Dodge Chance (replaces Wynn Agility on gear) | Skyy | | ✔ LOCKED (2026-09-24, change note 9) — part of the Acrobatics skill. A small % per Acrobatics level. Bigger upgrades in that skill tree. Also dodge accessories. Not a redesign of the rest of the tree |
...
| 6.50 | Custom starter powers + Ferocity caps | Skyy | | ✔ LOCKED (2026-09-25, change note 20) — Ferocity stays. Enchant cap 300. Total cap 600. Combat, gear, and accessories. Starters: Tank, Balance, Slayer, Lucky, Fast, Magical. Every starter grants a little Health and Defense. Powers use flat mana. Dedicated mana accessories use +% mana. No Power is pending. Stone powers stay pending. Combat 15 names were replaced later (change note 21) |
| 6.51 | Combat 15 power ladder | Skyy | | ✔ PART LOCK (2026-09-25, change note 21) — mirror starter themes, more extreme, buffs and debuffs, amounts scale with Accessory Power. Glass Cannon is Keep (from Slayer): −Health, −Defense, much more Strength and Crit Damage, solid Crit Chance. Drafts, pending confirm: Fortress, Harmony, Fortune, Blitz, Arcane. Scrap Hypixel names: Commando, Disciplined, Inspired, Ominous, Prepared. Debuff picks on the drafts are open |
