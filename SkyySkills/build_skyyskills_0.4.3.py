"""SkyySkills 0.4.3 - build script (derived from 0.4.2 by tools/skills_0_4_3_patch.py - edit the patch, not this file;
...
Run:   python build_skyyskills_0.4.3.py            -> SkyySkills/SkyySkills-0.4.3.jar
       python build_skyyskills_0.4.3.py --deploy   -> also copies to Mods/SkyySkills.jar and enables it in the HUD mod world
...
for c in (defs, cfg, sto, pub, fn, msg, fl, xp, plc, hg, btk, ptk, htk, bsy, psy, usy, ksy, tcm, top, page, tcmd, qcmd, rcmd, cmd, tick, pl, acfg, mvs_, acro, asy, afs,
          ...
          fcf, fdf, frd, fsn, fwt, fel, fdr, fcr, ffn, esy, pcg, pxp, pft, skit, karm):
    c.writeFile(OUT)
